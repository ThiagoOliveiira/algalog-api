...
import com.algaworks.algalog.domain.services.RegistroOcorrenciasService;
...
public class OcorrenciaController {	
	...
	private OcorrenciaModel registrar(@PathVariable Long entregaId,
		...
		Ocorrencia ocorrenciaRegistrada = registroOcorrenciasService.registrar(entregaId,
	...
	@GetMapping
	private List<OcorrenciaModel> listar(@PathVariable Long entregaId) {
